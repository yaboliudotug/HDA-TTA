...
Also supports the unsupervised contrastive loss (SimCLR) when labels are not provided.
"""
import torch
...
class SupervisedContrastiveLoss(nn.Module):
    ...
    If both labels and mask are None, degenerates to SimCLR unsupervised loss.
    """
